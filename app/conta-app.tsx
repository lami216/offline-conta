...
type SummaryBreakdownRow={id:string;label:string;meta?:string;value:number;source?:SummarySourceTarget};
type SummaryBreakdown={title:string;total:number;rows:SummaryBreakdownRow[]};
