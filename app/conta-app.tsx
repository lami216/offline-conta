...
const movementLabels: Record<string,MessageKey>={sale:"بيع","sale-edit":"تعديل فاتورة بيع","sale-edit-return":"إرجاع للمخزون — تعديل فاتورة بيع","sale-edit-extra":"زيادة بيع — تعديل فاتورة","sale-void":"إلغاء فاتورة بيع",purchase:"شراء","purchase-edit":"تعديل فاتورة شراء","purchase-edit-extra":"زيادة شراء — تعديل فاتورة","purchase-edit-return":"إرجاع للمورد — تعديل فاتورة شراء","purchase-edit-reversal":"عكس الشراء السابق — تغيير المخزن","purchase-void":"إلغاء فاتورة شراء","sale-return":"حركة تاريخية","transfer-in":"تحويل داخل","transfer-out":"تحويل خارج","transfer-edit":"تحويل مخزون بعد التعديل","transfer-edit-reversal":"عكس التحويل السابق — تعديل","transfer-void":"إلغاء تحويل مخزون",adjustment:"تصحيح مخزون","adjustment-edit":"تصحيح مخزون بعد التعديل","adjustment-edit-reversal":"عكس التصحيح السابق — تعديل","adjustment-void":"إلغاء تصحيح مخزون",opening:"رصيد بداية","opening-correction":"تصحيح رصيد البداية","legacy-opening":"رصيد بداية",expense:"مصروف","party-receipt":"تحصيل من طرف","party-payment":"دفع لطرف",payment:"دفعة",settlement:"تسوية",offset:"مقاصة","manual-deposit":"إيداع","manual-withdrawal":"سحب","opening-balance":"رصيد بداية","opening-balance-correction":"تصحيح رصيد البداية","balance-correction":"تصحيح رصيد سابق"};
