...
export const CAPABILITIES = [
  ...
  "warehouses.view","warehouses.create","warehouses.edit","warehouses.delete","warehouses.inventory.view","warehouses.transfer","warehouses.transfer.edit","warehouses.transfer.delete","warehouses.adjust","warehouses.adjust.edit","warehouses.adjust.delete","banks.view","banks.create","banks.edit","banks.delete","banks.movements.view","banks.transfer","banks.transfer.edit","banks.transfer.delete","banks.deposit_withdraw","banks.deposit_withdraw.edit","banks.deposit_withdraw.delete","banks.balance_correct",
