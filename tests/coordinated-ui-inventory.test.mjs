...
test("only review/history tables use shared sortable headers",()=>{
  for(const [start,end] of [["function InvoiceQuickBrowser","function Recent"],["function Recent","function Heading"],["function Expenses","type FinancialDetail"],["function Warehouses","function ProductMovementPanel"],["function ProductMovementPanel","function Products"],["function Transfer","function Adjustment"],["function Linked","function InvoiceQuickBrowser"]]){
